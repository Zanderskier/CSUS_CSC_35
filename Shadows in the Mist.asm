...
# 1. Assemble	: as -o final.o Shadows_In_TheMist.asm
...
#
#		Game structure is broken up (as much as I was able to) into 3 main areas, 1. the MAIN (Line: 1361) area where most most the game functinality and check and order of operations are,
#		2. Text output Subroutines (Line: 1826), here is where anything that will be outputed to a screen will be called from. 3. Game Logic (Line: 2393), this is where any shuffling of registors or values happens
...
GameExplain2:
	...
	.ascii " 120 days before you will go\ncompletely insane, regardless of your sanity levels; And you estimate that it will take 60 days of travel to reach the castle.\n"
...
GameOptions:
	.ascii "\t1. Hunt: Increase Health: 10-15 points, Decrease Stamina: 5-10 points, -1 Day to Travel, but risk becoming the hunted\n"
...
CombatOptions:
	...
	.ascii "\t3. Block: Defend from 10-30 points of damage; *Consume 5 Stamina; 10% chance to Sheild Bash for 5-25 points of damage*\n"
...
DreadClawText:
	.ascii "\tAs you stealthily make your way through the forest, searching for your next meal, you suddenly hear a rustling from above. Before you can\neven react, a "
	.ascii "massive creature with dark, matted fur and razor-sharp claws leaps down from the branches above, landing directly on top of you."
	.ascii "\n\n\tThe force of the impact knocks your bow from your hands as you struggle to push the creature off. Its glowing red eyes boring into your\nown, sending shivers "
	.ascii "down your spine as you realize that this is no ordinary Dread Claw. Its fur is darker and thicker than any you’ve ever seen,\nand its claws are longer and sharper. "
	.ascii "It lets out a bone-chilling snarl, revealing rows of jagged teeth as it prepares to strike again. You draw\nyour sword realizing that this is not going to be an easy fight\n\0"
...
MinotaurText:
	...
	.ascii "\n\tAs you turn a corner, you find yourself face to face with a creature that is holding the head of it's recently slain victim. This createure\nis unlike any you’ve ever seen. It has a humanoid figure, but its skin is "
	.ascii "covered in scales and its eyes glow an eerie green. It strikes you as\na minotaur, or a version of one. A creature thought to be a myth. The creature "
	.ascii "is wielding a long double bladed axe, and it lets out a guttural\ngrowl as it charges towards you. Your heart races as you realize this is no "
...
SpiderText:
	...
	.ascii " adult grizzle bear The creature continues to hiss and advance towards you, its eyes glinting in the dappled sunlight. You loose an arrow at it,\nstriking it "
	.ascii "in the fleshy part of its abdomen. You draw your sword, praying that the smell that just entered your nose is coming from this viel\ncreature and not your own set of trousers.\n\0"
...
Minotaur1:
	...
	.ascii "\t\t\t\t  || | | /\\ ;\\                   |l      _____     |;     ( \\/    > >\n"
	.ascii "\t\t\t\t  _\\\\)\\)\\)/ ;;;                  `8o __-~     ~\\   d|      \\      //\n"
	.ascii "\t\t\t\t ///(())(__/~;;\\                  \"88p;.  -. _\\_;.oP        (_._/ /\n"
	.ascii "\t\t\t\t(((__   __ \\\\   \\                  `>,% (\\  (\\./)8\"         ;:'  i\n"
	.ascii "\t\t\t\t)))--`.'-- (( ;,8 \\               ,;%%%:  ./V^^^V'          ;.   ;.\n"
	.ascii "\t\t\t\t((\\   |   /)) .,88  `: ..,,;;;;,-::::::'_::\\   ||\\         ;[8:   ;\n"
	.ascii "\t\t\t\t )|  ~-~  |(|(888; ..``'::::8888oooooo.  :\\`^^^/,,~--._    |88::  |\n"
	.ascii "\t\t\t\t |\\ -===- /|  \\8;; ``:.      oo.8888888888:`((( o.ooo8888Oo;:;:'  |\n"
	.ascii "\t\t\t\t |_~-___-~_|   `-\\.   `        `o`88888888b` )) 888b88888P\"\"'     ;\n"
	.ascii "\t\t\t\t ; ~~~~;~~         \"`--_`.       b`888888888;(.,\"888b888\"  ..::;-'\n"
	.ascii "\t\t\t\t   ;      ;              ~\"-....  b`8888888:::::.`8888. .:;;;''\n"
	.ascii "\t\t\t\t      ;    ;                 `:::. `:::OOO:::::::.`OO' ;;;''\n"
	.ascii "\t\t\t\t :       ;                     `.      \"``::::::''    .'\n"
	.ascii "\t\t\t\t    ;                           `.   \\_              /\n"
	.ascii "\t\t\t\t  ;       ;                       +:   ~~--  `:'  -';\n"
...
###################################################################################### MAIN ######################################################################################
_start:
	call ClearScreen						# clear screen for game
...
MeditationEvents:
	call RandomEvent
	cmp r15, 40								# 40% chance of getting Enlightened event
	jle opt3Good
...
CheckInsanityVsCastle:							# Checks days to insane vs days to castle if insanity days greater, go insane
	mov r12, 0
	mov r13, 0
	...
	cmp r13, -5 								# if the insane < days to castle, hero becomes lost this indicates that the insanity timer runs out before escape counter	
	jl ForestFlag
	...
	cmp r12, 5 								# if the insane < days to castle, hero becomes lost this indicates that the insanity timer runs out before escape counter	
	jg ForestFlag
...
DreadClawAttack:
	mov rdi, 16								# does 5-20 points of damage per hit
	call Random
	add rdi, 5
...
MinoataurAttack:
	mov rdi, 31								# does 5-35 points of damage per hit
	call Random
	add rdi, 5
	mov rcx, rdi								# move Monster temp attack int rcx
	mov r12, rcx								# health changed by
...
FailBash:
	mov rdi, 21								# block 10-30 points of damage
	call Random
	add rdi, 10
...
BlockFail:				
	...
	mov r14, rdi								# ammount of damaged Blocked by monster
	mov r12, rcx								# health changed by
	sub r8, rcx
	ret
...
BlockSuccess:
	mov r12, 0
	mov r14, rdi						# Delta Blocked for value
	ret
